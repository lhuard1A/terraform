		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWKmsKeyHasPolicy("aws_kms_key.foo", expectedPolicyText),
				),
			},
		},
	})
...
func testAccCheckAWKmsKeyHasPolicy(name string, expectedPolicyText string) resource.TestCheckFunc {
